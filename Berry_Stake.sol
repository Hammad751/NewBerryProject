...
///////////////////////////////////////////////////////////////
    ...
    uint256 public finalTimeForDutchMint = 7 minutes;      // 100 days
    uint256 public maxNoOfdaysForFreeMint = 7;             // 216000
    uint256 public maxNoOfdaysForDutchMint = 7;            //  144000

    uint256 public bonusReward = 300000000000000000000;    //  300 token bonus
    ...
    function lockedReward(uint256 tokenId) public view returns(uint256 idReward_, uint256 bonusReward_){
        uint256 reward;
        uint256 bonus;
        ...
        return ((reward - rewardedAmount[_user][tokenId]), bonus);
    }
    ...
    function userSingleReward( address _user,uint256 tokenId) public view returns(uint256 tokenIdReward_, uint256 bonusReward_){
        uint256 reward;
        uint256 bonus;
    ...
    function WithdrawReward(uint256 TokenId)  public {
       ...
       if(NFT.getIdType(TokenId) == 3 || NFT.getIdType(TokenId) == 4){

            if(!alreadyAwarded[NFT.getIdType(TokenId)]){
                totalReward = reward + bonusReward;
                alreadyAwarded[NFT.getIdType(TokenId)] = true;  // true the tokenId type
            }
        }
    ...
    function setPrePublicReward(uint256 tokenIdReward) public onlyOwner{
        commonReward = tokenIdReward;
    }
    function setBreedReward(uint256 tokenIdReward) public onlyOwner{
